...
namespace HWID_Changer
{
    class Program
    {
        ...
        public static void Menu()
        {
            ...
            switch (input)
            {
                ...
                case "ALL":
                    ...
                    SpoofEFIVariableId();
                    SpoofInstallationID();
                    Console.WriteLine("\n Spoofed everything. Restarting is recommended");
                    ClearConsoleAfterDelay();
                    Menu();
                    break;
                default:
        ...
        static void Main()
        {
            Console.Title = "Echo Spoofer";
            Console.WriteLine(" ________           __                                                                 ______                     \r\n|        \\         |  \\                                                               /      \\                    \r\n| $$$$$$$$ _______ | $$____    ______          _______   ______    ______    ______  |  $$$$$$\\ ______    ______  \r\n| $$__    /       \\| $$    \\  /      \\        /       \\ /      \\  /      \\  /      \\ | $$_  \\$$/      \\  /      \\ \r\n| $$  \\  |  $$$$$$$| $$$$$$$\\|  $$$$$$\\      |  $$$$$$$|  $$$$$$\\|  $$$$$$\\|  $$$$$$\\| $$ \\   |  $$$$$$\\|  $$$$$$\\\r\n| $$$$$  | $$      | $$  | $$| $$  | $$       \\$$    \\ | $$  | $$| $$  | $$| $$  | $$| $$$$   | $$    $$| $$   \\$$\r\n| $$_____| $$_____ | $$  | $$| $$__/ $$       _\\$$$$$$\\| $$__/ $$| $$__/ $$| $$__/ $$| $$     | $$$$$$$$| $$      \r\n| $$     \\\\$$     \\| $$  | $$ \\$$    $$      |       $$| $$    $$ \\$$    $$ \\$$    $$| $$      \\$$     \\| $$      \r\n \\$$$$$$$$ \\$$$$$$$ \\$$   \\$$  \\$$$$$$        \\$$$$$$$ | $$$$$$$   \\$$$$$$   \\$$$$$$  \\$$       \\$$$$$$$ \\$$      \r\n                                                       | $$                                                       \r\n                                                       | $$                                                       \r\n                                                        \\$$                                                       ");


            Console.WriteLine("[1] Spoof HWID                       [5] Spoof PC Name            ");
            Console.WriteLine("[2] Spoof GUID                       [6] Spoof Installation ID    ");
            Console.WriteLine("[3] Spoof MAC ID                     [7] Spoof EFI                ");
            Console.WriteLine("[4] Spoof SMBIOS                     [8] Spoof GPU ID");
            Console.WriteLine("[ALL] Spoof all (MAY BRICK YOUR PC YOU HAVE BEEN WARNED)                                ");
            Console.WriteLine("  ");
            Menu();
        }
    }
